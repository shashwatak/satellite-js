...
import { twoline2satrec, json2satrec, OMMJsonObject, SatRec } from '../src/index.js';
...
describe('OMM Epoch', () => {
  it('must be parsed with or without ending Z', () => {
    ...
    expect(json2satrec(goodDataExampleWithEpochEndingInZ as OMMJsonObject)).toEqual(json2satrec(goodDataExample as OMMJsonObject));
  })
});
