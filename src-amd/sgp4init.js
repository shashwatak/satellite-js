...
define([
    ...
    return function(satrec, sgp4initParameters) {
        ...
        if (omeosq >= 0.0 || satrec.no >= 0.0){
            ...
            (4.0 + etasq)) + 0.375 * constants.js * tsi / psisq * satrec.con41 *
            ...
            (0.5 + 2.0 * etasq) - constants.js * tsi / (ao * psisq) *
            ...
            temp1  = 1.5 * constants.js * pinvsq * satrec.no;
            temp2  = 0.5 * temp1 * constants.js * pinvsq;
